...
void register_function(uint32_t number,void * function){

    IDT_handle_function[number]=function;

}

void timer_interuption(){
...
void idt_init(){
    ...
    register_function(0x20,timer_interuption);
